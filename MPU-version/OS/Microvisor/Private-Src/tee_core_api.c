...
__attribute__((section(".microvisor-nopri"))) void* TEE_Malloc(size_t size, uint32_t hint)
{
	uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
    uint32_t temp_val_r6 = 0;
    
    // Understand which TA (TA1 or TA2) is calling the function using the stack pointer value
    register uintptr_t PSP_value asm("sp");
    uint32_t ta_num = 0;
    void* ret_val = NULL;

    // Check if the stack pointer value is in the range of the TA1 or TA2 memory area
    // If the value is outside of these ranges, return with an error
    if ((PSP_value >= TA1_MEMORY_START_ADDR) && (PSP_value <= TA1_MEMORY_END_ADDR)) {
        ta_num = 1;
    } else if ((PSP_value >= TA2_MEMORY_START_ADDR) && (PSP_value <= TA2_MEMORY_END_ADDR)) {
        ta_num = 2;
    } else {
        return;
    }
...
__attribute__((section(".microvisor-nopri"))) void TEE_Free(void* buffer)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_MemMove(void* dest, void* src, size_t size)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
    uint32_t temp_val_r6 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_MemFill(void* buffer, uint8_t x, size_t size)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
    uint32_t temp_val_r6 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_BigIntConvertToS32(int32_t *dest, TEE_BigInt *src) 
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
...
__attribute__((section(".microvisor-nopri"))) int32_t TEE_BigIntCmpS32(TEE_BigInt *op, int32_t shortVal) 
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_BigIntMod(TEE_BigInt *dest, TEE_BigInt *op, TEE_BigInt *n) 
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
    uint32_t temp_val_r6 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_BigIntDiv(TEE_BigInt *dest_q, TEE_BigInt *dest_r, TEE_BigInt *op1, TEE_BigInt *op2) 
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
    uint32_t temp_val_r6 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_BigIntConvertFromOctetString(TEE_BigInt *dest, uint8_t *buffer, size_t bufferLen, int32_t sign)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
    uint32_t temp_val_r6 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_BigIntInit(TEE_BigInt *bigInt, size_t len)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_AllocateTransientObject(uint32_t objectType,
...
__attribute__((section(".microvisor-nopri")))  TEE_Result TEE_PopulateTransientObject(TEE_ObjectHandle object,
...
__attribute__((section(".microvisor-nopri"))) void TEE_InitRefAttribute(TEE_Attribute* attr, uint32_t attributeID,    
...
__attribute__((section(".microvisor-nopri"))) void TEE_InitValueAttribute(TEE_Attribute* attr, uint32_t attributeID,  
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_GetObjectBufferAttribute(TEE_ObjectHandle object, uint32_t attributeID,
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_GetObjectValueAttribute(TEE_ObjectHandle object, uint32_t attributeID,
...
__attribute__((section(".microvisor-nopri"))) void TEE_FreeTransientObject(TEE_ObjectHandle object)
{
    uint32_t temp_val_r4 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_CloseObject(TEE_ObjectHandle object)
{
    uint32_t temp_val_r4 = 0;
...
__attribute__((section(".microvisor-nopri")))  TEE_Result TEE_ReadObjectData(TEE_ObjectHandle object,
                                                                            /*[out]*/   void* buffer,
                                                                                        size_t size,
                                                                            /*[out]*/   size_t* count)
{
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_WriteObjectData(TEE_ObjectHandle object,
                                                                            /*[inbuf]*/ void* buffer, 
                                                                                        size_t size)
{
    uint32_t temp_val_r4 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_CreatePersistentObject(uint32_t storageID,
                                                                        ...
                                                                        /*[outopt]*/ TEE_ObjectHandle* object )
{
    ...
    // as no other registers are available in the manual frame 
    storageID = ta_num;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_OpenPersistentObject(uint32_t storageID,
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_CloseAndDeletePersistentObject1(TEE_ObjectHandle object)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_AllocateOperation(TEE_OperationHandle* operation,           
                                                                                uint32_t algorithm,
                                                                                uint32_t mode, 
                                                                                uint32_t maxKeySize) 
{
...
__attribute__((section(".microvisor-nopri"))) void TEE_FreeOperation(TEE_OperationHandle operation)                         
{
    uint32_t temp_val_r4 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_SetOperationKey(TEE_OperationHandle operation,              
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_GenerateKey(TEE_ObjectHandle object,                     
                                                                        uint32_t keySize,
...
__attribute__((section(".microvisor-nopri"))) void TEE_GenerateRandom(void* randomBuffer, size_t randomBufferLen)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_DeriveKey(TEE_OperationHandle operation, TEE_Attribute* params, uint32_t paramCount, TEE_ObjectHandle derivedKey)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
    uint32_t temp_val_r6 = 0;
...
__attribute__((section(".microvisor-nopri"))) void TEE_CipherInit(TEE_OperationHandle operation,
                                                                    void* IV, 
                                                                    size_t IVLen)
{   
    uint32_t temp_val_r4 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_CipherUpdate(TEE_OperationHandle operation,
                                                                    void* srcData, 
                                                                    size_t srcLen,
                                                                    void* destData,
                                                                    size_t* destLen)
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_CipherDoFinal(TEE_OperationHandle operation,
                                                                    void* srcData, 
                                                                    size_t srcLen,
                                                                    void* destData,
                                                                    size_t* destLen)
...
__attribute__((section(".microvisor-nopri"))) void TEE_MACInit(TEE_OperationHandle operation,                             
...
__attribute__((section(".microvisor-nopri"))) void TEE_MACUpdate(TEE_OperationHandle operation,
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_MACComputeFinal(TEE_OperationHandle operation,
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_AsymmetricSignDigest(TEE_OperationHandle operation,
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_AsymmetricVerifyDigest(TEE_OperationHandle operation,
                        /*[in]*/       TEE_Attribute* params, uint32_t paramCount,
                        /*[inbuf]*/    void* digest, size_t digestLen,
...
__attribute__((section(".microvisor-nopri"))) void TEE_DigestUpdate(TEE_OperationHandle operation,
                                                    /*inbuf]*/     void* chunk, size_t chunkSize)
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_DigestDoFinal(TEE_OperationHandle operation,
...
__attribute__((section(".microvisor-nopri"))) TEE_Result TEE_DigestExtract(TEE_OperationHandle operation,
                                                         /*[outbuf]*/       void* hash, size_t *hashLen) 
{
    uint32_t temp_val_r4 = 0;
    uint32_t temp_val_r5 = 0;
