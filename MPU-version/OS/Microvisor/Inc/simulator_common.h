...
/* Functions to retrieve the permissions of a simulated function on a given
 * address */
 ...
 * @param   halfword_count: The variable where the actual instruction length in
 * halfwords is put (1 or 2).
 *
