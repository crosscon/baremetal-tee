 ...
 */
#define LDR_I3_LDRH_LDRB_I2_LDRSH_LDRSB_I1_MASK	0b11111111111100000000000000000000
 ...
 * cover all possible combinations so they must be specified manually
 */
#define LDR_I4_LDRH_LDRB_I3_LDRSH_LDRSB_I2_MASK	0b11111111111100000000100000000000
