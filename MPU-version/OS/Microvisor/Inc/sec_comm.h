...
typedef struct {
  mbedtls_chachapoly_context
      ccp_ctx; // chachapoly context for encryption/decryption operations
  uint32_t socket;
...
/**
 * @brief Attempts to send specified amount of bytes encrypting and
 * authenticating them
 * @param ctx : sec_comm_context
...
/**
 * @brief Attempts to retrieve specified amount of bytes of plaintext
 * (decrypting new packets if necessary)
 * @param ctx : sec_comm_context
