...
// Entry point for the TEE Core API: see the tee_core_api.c file to have more
// details about the implementation and the execution flow of the TEE Core API
// functions
...
TEE_Result
TEE_AsymmetricVerifyDigest(TEE_OperationHandle operation,
