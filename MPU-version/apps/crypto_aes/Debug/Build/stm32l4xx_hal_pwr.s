...
.Ltext0:
	...
	.file 1 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr.c"
...
.LFB77:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 314 3 view .LVU11
	.loc 1 315 3 view .LVU12
	.loc 1 318 3 view .LVU13
	ldr	r2, .L15
	ldr	r3, [r2, #4]
	bic	r3, r3, #14
	ldr	r1, [r0]
	orrs	r3, r3, r1
	str	r3, [r2, #4]
	.loc 1 321 3 view .LVU14
	ldr	r3, .L15+4
	ldr	r2, [r3, #4]
	bic	r2, r2, #65536
	str	r2, [r3, #4]
	.loc 1 322 3 view .LVU15
	ldr	r2, [r3]
	bic	r2, r2, #65536
	str	r2, [r3]
	.loc 1 323 3 view .LVU16
	ldr	r2, [r3, #12]
	bic	r2, r2, #65536
	str	r2, [r3, #12]
	.loc 1 324 3 view .LVU17
	ldr	r2, [r3, #8]
	bic	r2, r2, #65536
	str	r2, [r3, #8]
	.loc 1 327 3 view .LVU18
	.loc 1 327 17 is_stmt 0 view .LVU19
	ldr	r3, [r0, #4]
	.loc 1 327 5 view .LVU20
	tst	r3, #65536
	beq	.L11
	.loc 1 329 5 is_stmt 1 view .LVU21
	ldr	r2, .L15+4
	ldr	r3, [r2]
	orr	r3, r3, #65536
	str	r3, [r2]
.L11:
	.loc 1 333 3 view .LVU22
	.loc 1 333 17 is_stmt 0 view .LVU23
	ldr	r3, [r0, #4]
	.loc 1 333 5 view .LVU24
	tst	r3, #131072
	beq	.L12
	...
	str	r3, [r2, #4]
.L12:
	.loc 1 339 3 view .LVU26
	.loc 1 339 17 is_stmt 0 view .LVU27
	ldr	r3, [r0, #4]
	.loc 1 339 5 view .LVU28
	tst	r3, #1
	beq	.L13
	.loc 1 341 5 is_stmt 1 view .LVU29
	ldr	r2, .L15+4
	ldr	r3, [r2, #8]
	orr	r3, r3, #65536
	str	r3, [r2, #8]
.L13:
	.loc 1 344 3 view .LVU30
	.loc 1 344 17 is_stmt 0 view .LVU31
	ldr	r3, [r0, #4]
	.loc 1 344 5 view .LVU32
	tst	r3, #2
	beq	.L14
	.loc 1 346 5 is_stmt 1 view .LVU33
	ldr	r2, .L15+4
	ldr	r3, [r2, #12]
	orr	r3, r3, #65536
	str	r3, [r2, #12]
.L14:
	.loc 1 349 3 view .LVU34
	.loc 1 350 1 is_stmt 0 view .LVU35
	movs	r0, #0
.LVL1:
	.loc 1 350 1 view .LVU36
	bx	lr
.L16:
	.align	2
.L15:
...
.LFB78:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 359 3 view .LVU38
	ldr	r2, .L18
	ldr	r3, [r2, #4]
	orr	r3, r3, #1
	str	r3, [r2, #4]
	.loc 1 360 1 is_stmt 0 view .LVU39
	bx	lr
.L19:
	.align	2
.L18:
...
.LFB79:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 368 3 view .LVU41
	ldr	r2, .L21
	ldr	r3, [r2, #4]
	bic	r3, r3, #1
	str	r3, [r2, #4]
	.loc 1 369 1 is_stmt 0 view .LVU42
	bx	lr
.L22:
	.align	2
.L21:
...
.LFB80:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 393 3 view .LVU44
	.loc 1 397 3 view .LVU45
	ldr	r2, .L24
	ldr	r3, [r2, #12]
	and	r1, r0, #31
	bic	r3, r3, r1
	orr	r0, r3, r0, lsr #5
.LVL3:
	.loc 1 397 3 is_stmt 0 view .LVU46
	str	r0, [r2, #12]
	.loc 1 400 3 is_stmt 1 view .LVU47
	ldr	r3, [r2, #8]
	orrs	r1, r1, r3
	str	r1, [r2, #8]
	.loc 1 403 1 is_stmt 0 view .LVU48
	bx	lr
.L25:
	.align	2
.L24:
...
.LFB81:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 414 3 view .LVU50
	.loc 1 416 3 view .LVU51
	ldr	r2, .L27
	ldr	r3, [r2, #8]
	and	r0, r0, #31
.LVL5:
	.loc 1 416 3 is_stmt 0 view .LVU52
	bic	r3, r3, r0
	str	r3, [r2, #8]
	.loc 1 417 1 view .LVU53
	bx	lr
.L28:
	.align	2
.L27:
...
.LFB82:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 445 1 is_stmt 0 view .LVU55
	push	{r4, lr}
.LCFI0:
	...
	.cfi_offset 14, -4
	mov	r4, r1
	.loc 1 447 3 is_stmt 1 view .LVU56
	.loc 1 448 3 view .LVU57
	.loc 1 451 3 view .LVU58
	.loc 1 451 6 is_stmt 0 view .LVU59
	cbnz	r0, .L30
	.loc 1 454 5 is_stmt 1 view .LVU60
	.loc 1 454 9 is_stmt 0 view .LVU61
	ldr	r3, .L37
	ldr	r3, [r3, #20]
	.loc 1 454 8 view .LVU62
	tst	r3, #512
	bne	.L35
.LVL7:
.L31:
	.loc 1 474 3 is_stmt 1 view .LVU63
	ldr	r2, .L37+4
	ldr	r3, [r2, #16]
	bic	r3, r3, #4
	str	r3, [r2, #16]
	.loc 1 477 3 view .LVU64
	.loc 1 477 5 is_stmt 0 view .LVU65
	cmp	r4, #1
	beq	.L36
	.loc 1 485 5 is_stmt 1 view .LVU66
	.syntax unified
@ 485 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr.c" 1
	sev
@ 0 "" 2
	.loc 1 486 5 view .LVU67
@ 486 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr.c" 1
	wfe
@ 0 "" 2
	.loc 1 487 5 view .LVU68
@ 487 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr.c" 1
	wfe
@ 0 "" 2
	.thumb
	.syntax unified
.L29:
	.loc 1 490 1 is_stmt 0 view .LVU69
	pop	{r4, pc}
.LVL8:
.L35:
	.loc 1 456 7 is_stmt 1 view .LVU70
	.loc 1 456 11 is_stmt 0 view .LVU71
	bl	HAL_PWREx_DisableLowPowerRunMode
.LVL9:
	.loc 1 456 10 view .LVU72
	cmp	r0, #0
	beq	.L31
	b	.L29
.LVL10:
.L30:
	.loc 1 467 5 is_stmt 1 view .LVU73
	.loc 1 467 9 is_stmt 0 view .LVU74
	ldr	r3, .L37
	ldr	r3, [r3, #20]
	.loc 1 467 8 view .LVU75
	tst	r3, #512
	bne	.L31
	.loc 1 469 7 is_stmt 1 view .LVU76
	bl	HAL_PWREx_EnableLowPowerRunMode
.LVL11:
	.loc 1 469 7 is_stmt 0 view .LVU77
	b	.L31
.L36:
	.loc 1 480 5 is_stmt 1 view .LVU78
	.syntax unified
@ 480 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr.c" 1
	wfi
@ 0 "" 2
	.thumb
	.syntax unified
...
.LFB83:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 524 1 is_stmt 0 view .LVU80
	push	{r3, lr}
.LCFI1:
	.cfi_def_cfa_offset 8
	.cfi_offset 3, -8
	.cfi_offset 14, -4
	.loc 1 526 3 is_stmt 1 view .LVU81
	.loc 1 528 3 view .LVU82
	.loc 1 528 5 is_stmt 0 view .LVU83
	cmp	r0, #16384
	beq	.L43
	.loc 1 534 5 is_stmt 1 view .LVU84
	mov	r0, r1
.LVL13:
	.loc 1 534 5 is_stmt 0 view .LVU85
	bl	HAL_PWREx_EnterSTOP0Mode
.LVL14:
.L39:
	.loc 1 536 1 view .LVU86
	pop	{r3, pc}
.LVL15:
.L43:
	.loc 1 530 5 is_stmt 1 view .LVU87
	mov	r0, r1
.LVL16:
	.loc 1 530 5 is_stmt 0 view .LVU88
	bl	HAL_PWREx_EnterSTOP1Mode
.LVL17:
	.loc 1 530 5 view .LVU89
	b	.L39
	.cfi_endproc
.LFE83:
...
.LFB84:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 559 3 view .LVU91
	ldr	r2, .L45
	ldr	r3, [r2]
	bic	r3, r3, #7
	orr	r3, r3, #3
	str	r3, [r2]
	.loc 1 562 3 view .LVU92
	ldr	r2, .L45+4
	ldr	r3, [r2, #16]
	orr	r3, r3, #4
	str	r3, [r2, #16]
	.loc 1 569 3 view .LVU93
	.syntax unified
@ 569 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr.c" 1
	wfi
@ 0 "" 2
	.loc 1 570 1 is_stmt 0 view .LVU94
	.thumb
	.syntax unified
	bx	lr
.L46:
...
.LFB85:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 585 3 view .LVU96
	ldr	r2, .L48
	ldr	r3, [r2, #16]
	orr	r3, r3, #2
	str	r3, [r2, #16]
	.loc 1 586 1 is_stmt 0 view .LVU97
	bx	lr
.L49:
	.align	2
.L48:
...
.LFB86:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 598 3 view .LVU99
	ldr	r2, .L51
	ldr	r3, [r2, #16]
	bic	r3, r3, #2
	str	r3, [r2, #16]
	.loc 1 599 1 is_stmt 0 view .LVU100
	bx	lr
.L52:
	.align	2
.L51:
...
.LFB87:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 612 3 view .LVU102
	ldr	r2, .L54
	ldr	r3, [r2, #16]
	orr	r3, r3, #16
	str	r3, [r2, #16]
	.loc 1 613 1 is_stmt 0 view .LVU103
	bx	lr
.L55:
	.align	2
.L54:
...
.LFB88:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 625 3 view .LVU105
	ldr	r2, .L57
	ldr	r3, [r2, #16]
	bic	r3, r3, #16
	str	r3, [r2, #16]
	.loc 1 626 1 is_stmt 0 view .LVU106
	bx	lr
.L58:
	.align	2
.L57:
...
.Letext0:
	...
	.file 8 "../Drivers/STM32L4xx_HAL_Driver/Inc/stm32l4xx_hal_pwr.h"
	.file 9 "../Drivers/STM32L4xx_HAL_Driver/Inc/stm32l4xx_hal_pwr_ex.h"
